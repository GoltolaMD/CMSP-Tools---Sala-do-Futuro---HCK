javascript:(()=>{
  ...
  const THEMES = {
    ...
    colorful: `
      #cmsp-tools {
        background: linear-gradient(135deg, #00ff00, #000000); color: #fff;
      }
      #cmsp-tools a {
  ...
  box.innerHTML = `
    ...
    <div style="margin: 10px 0;">
      ...
      <button onclick="(${applyTheme.toString()})('colorful')" style="background:linear-gradient(45deg,#00ff00,#000000);color:#fff;">🌈 Colorido</button>
    </div>
    <div>
