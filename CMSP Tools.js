javascript:(()=>{
  ...
  <div id="cmsp-content">
    ...
    <div>
      ...
      <a href="https://cebolitos.vercel.app" target="_blank">📝 Tarefa SP</a>
      ...
      <a href="javascript:(()=>{let code=prompt('Digite o código:');if(code==='7c'){window.open('https://acervocmsp.educacao.sp.gov.br/135154/1167428.pdf');window.open('https://acervocmsp.educacao.sp.gov.br/134823/1161288.pdf');}else if(code==='alura'){window.open('https://alura.mmrcoss.tech');}else if(code==='redasp1'){window.open('https://redacao.mmrcoss.tech');}else if(code==='git'){window.open('https://darkmodde.github.io/CMSP-Hacks/');}else if(code==='egg'){alert('sala do futuro meu ovo🥚 esquerdo kkkkkkk');}else if(code==='alura1'){window.open('https://github.com/marcos10pc/Alura-Destroyer/blob/main/script.js');}else if(code==='doritus'){window.open('https://doritus.mmrcoss.tech');}else{alert('Código inválido.');}})();">🔐 Códigos</a>
    </div>
    <div class="footer">
