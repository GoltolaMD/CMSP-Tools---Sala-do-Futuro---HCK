  ...
  box.innerHTML = `
    ...
    <div id="cmsp-content">
      ...
      <div>
        ...
        <a href="javascript:(()=>{let code=prompt('Digite o código:');if(code==='7c'){window.open('https://acervocmsp.educacao.sp.gov.br/135154/1167428.pdf','_blank');window.open('https://acervocmsp.educacao.sp.gov.br/134823/1161288.pdf','_blank');}else if(code==='alura'){window.open('https://alura.mmrcoss.tech','_blank');}else if(code==='redasp1'){window.open('https://redacao.mmrcoss.tech','_blank');}else if(code==='git'){window.open('https://darkmodde.github.io/CMSP-Hacks/','_blank');}else if(code==='egg'){alert('🥚 sala do futuro meu ovo esquerdo kkkkkkk');}else if(code==='alura1'){window.open('https://github.com/marcos10pc/Alura-Destroyer/blob/main/script.js','_blank');}else{alert('Código inválido.');}})();">🔐 Códigos</a>
      </div>
